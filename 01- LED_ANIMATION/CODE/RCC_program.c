...
void RCC_voidEnableClock(u8 Copy_u8BusId, u8 Copy_u8BperId) 
{
    if(Copy_u8BperId <= 31)
	{
		switch(Copy_u8BusId)
...
*
*******************************************************************************/
void RCC_voidDisableClock(u8 Copy_u8BusId, u8 Copy_u8BperId) 
{
    if(Copy_u8BperId <= 31)
	{
		switch(Copy_u8BusId)

...
u8 MGPIO_u8ChoosePullMode(GPIO_PinId_t copy_u8PinId, GPIO_PULL_MODE_t Copy_Mode)
{
    GPIO_PortId_t copy_u8PortId;
    if(copy_u8PinId >= GPIO_PORTA_ENTRY && copy_u8PinId <= GPIO_PORTA_END)
    {
...
void MGPIO_voidTogPinValue (GPIO_PinId_t copy_u8PinId)
{
    GPIO_PortId_t copy_u8PortId;
    if(copy_u8PinId >= GPIO_PORTA_ENTRY && copy_u8PinId <= GPIO_PORTA_END)
    {
...
void MGPIO_voidSetPortMode (GPIO_PinId_t copy_u8StPin, GPIO_PinId_t copy_u8EdPin, GPIO_PIN_MODE copy_u8Mode)
{
	for (GPIO_PinId_t pins = copy_u8StPin ;pins <= copy_u8EdPin ;pins++)
    {
		MGPIO_voidSetPinMode(pins, copy_u8Mode);
	}
}

void MGPIO_voidSetPortValue (GPIO_PortId_t copy_u8PortId , u16 copy_u16Value)
{
    switch(copy_u8PortId)
    {
        case PORTA :
...
void MGPIO_voidSetClrPinsValue (GPIO_PortId_t copy_u8PortId, u32 copy_u32Value)
{
    switch(copy_u8PortId)
    {
         case PORTA :
...
void MGPIO_voidSetPinsValue (GPIO_PortId_t copy_u8PortId, u16 copy_u16Value)
{
    switch(copy_u8PortId)
    {
        case PORTA :
...
void MGPIO_voidClrPinsValue (GPIO_PortId_t copy_u8PortId, u16 copy_u16Value)
{
    switch(copy_u8PortId)
    {
        case PORTA :
...
u8 MGPIO_u8LockBitConfig(GPIO_PinId_t copy_u8PinId)
{
    GPIO_PortId_t copy_u8PortId;
	  u8 LCKValue  = 0;
    u8 LCKKValue = 0;

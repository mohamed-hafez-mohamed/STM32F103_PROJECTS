...
static u8  volatile      Static_u8SingleUs;
static u8  volatile      Static_u8PeriodcUs;
static u8  volatile      Static_u8SingleMs;
static u8  volatile      Static_u8PeriodicMs;
static u8  volatile      Static_u8DelayFlag;
static u32 volatile      Static_u32Ticks;
/******************************************************************************
* Function Prototypes
*******************************************************************************/
